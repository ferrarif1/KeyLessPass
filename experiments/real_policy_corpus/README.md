...
The 32-character ceiling is an evaluation resource bound. ASTER's exact-domain
compiler separately enforces its documented policy-length and state-space
limits and fails closed when either limit is exceeded.
