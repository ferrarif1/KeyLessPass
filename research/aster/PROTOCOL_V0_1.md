...
ASTER compiles the bounded accepted policy into an exactly counted finite language.
...
## 13. Evaluation controls and prior-work positioning

Protocol guards are evaluated with controlled fault injection: omitted scope
fields, endpoint placement of reusable secret material, unchanged-key share
refresh after disclosure, and unsafe lifecycle transitions. These are negative
controls, not comparison systems. System-to-system positioning is limited to
publicly available, cited prior work.
