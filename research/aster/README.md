...
Build the journal attachment from the explicit ASTER allow-list:

```sh
python3 research/aster/scripts/build_supplementary_artifact.py \
  research/aster/submission/cee_2026-08-11_v2/final/ASTER_CEE_Supplementary_Artifact.zip
```

The builder excludes manuscript, submission, cache, log, and unrelated research
trees. It also rejects retired internal research names in archived paths and
text, preventing an older draft or prototype from being presented as an ASTER
comparison system.
