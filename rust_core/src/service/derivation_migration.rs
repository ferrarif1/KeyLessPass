...
use crate::derivation::{
    derive_password_v3, derive_password_v3_with_policy, policy_spec_from_encoding_descriptor,
    DomainPermutation, Ff1CycleWalking,
};
use crate::domain::{
...
pub fn select_v3_generation_avoiding_history(
    ...
    let policy = policy_spec_from_encoding_descriptor(&pending.encoding_descriptor)?;
